function afterTaskCreate(colleagueId){
	...
	if(atividadeAtual == atv_aprovacao){
		var assunto 		= "Solicitação de Alteração de Função";
		var status 			= "Aprovada";
...
function enviaEmail(assunto, status, dataAtual, destinatario, atividade){
	...
	try{
		...
		var subject = "[WF" + processo + "] - Solicitação de Alteração de Função";
		...
		notifier.notify("admin", "tplEmailAltFunc", parametros, destinatario, "text/html");
